// ============================================================================
//  Core twin — the signature-searchable function registry (Phase 558), moved
//  behind the core-twins boundary in Phase 1861; @fuaran-ui/ui re-exports it.
//  The native-TS reimplementation of the F# reference
